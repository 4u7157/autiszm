...
else if [ "$defconfig" == "exynos7870-gtaxllte_defconfig" ]; then
read -p "Non Treble AOSP(1) or Treble AOSP(2) or OneUI(3) or Treble OneUI(4): " type

else if [ "$defconfig" == "exynos7870-gtaxlwifi_defconfig" ]; then
read -p "Non Treble AOSP(1) or Treble AOSP(2) or OneUI(3) or Treble OneUI(4): " type
...
else if [ "$defconfig" == "exynos7870-a2corelte_defconfig" ]; then
